...
import { CheckCircle, Download, ArrowLeft, Play, BookOpen, Sparkles, HelpCircle } from 'lucide-react';
          ...
          <div className="max-w-3xl mx-auto">
            ...
            >
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-xl">
                  ...
                  <span className="text-sm">10,000+ ready-to-use automation workflows</span>
                </div>
                <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-xl">
                  <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                ...
                <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-xl">
                  <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                  <span className="text-sm">Free future updates</span>
                </div>
                <div className="flex items-start gap-3 p-4 bg-gray-50 rounded-xl">
                  <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Watch this video to get started</p>
                </div>
              </div>
              ...
              <p className="text-sm text-muted-foreground mt-4 text-center">
                This video covers the basics of using your automation workflows
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-sm text-muted-foreground">
                Having trouble downloading or setting up? Contact us at{' '}
