  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all duration-300 ease-out rounded-full focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 transform-gpu [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        brutal:
          "relative bg-foreground text-background font-semibold tracking-tight overflow-hidden shadow-[0_4px_20px_rgba(0,0,0,0.15)] hover:shadow-[0_8px_40px_rgba(0,0,0,0.3)] hover:-translate-y-1 hover:scale-[1.02] active:scale-[0.98] active:translate-y-0 active:shadow-[0_4px_15px_rgba(0,0,0,0.2)] transition-all duration-300 before:absolute before:inset-0 before:bg-gradient-to-r before:from-transparent before:via-white/20 before:to-transparent before:animate-[glow-sweep_2.5s_ease-in-out_infinite] after:absolute after:inset-0 after:rounded-[inherit] after:shadow-[0_0_25px_rgba(0,0,0,0.4),inset_0_1px_0_rgba(255,255,255,0.15)] after:opacity-0 hover:after:opacity-100 after:transition-opacity after:duration-300",
        "brutal-outline":
        ...
        premium:
          "relative bg-gradient-to-r from-gray-900 via-black to-gray-900 text-white font-semibold tracking-tight overflow-hidden shadow-[0_4px_20px_rgba(0,0,0,0.2)] hover:shadow-[0_10px_45px_rgba(0,0,0,0.4)] hover:-translate-y-1 hover:scale-[1.02] active:scale-[0.98] active:translate-y-0 transition-all duration-300 before:absolute before:inset-0 before:bg-gradient-to-r before:from-transparent before:via-white/30 before:to-transparent before:animate-[glow-sweep_2.5s_ease-in-out_infinite] after:absolute after:inset-0 after:rounded-[inherit] after:shadow-[0_0_30px_rgba(0,0,0,0.5),inset_0_1px_0_rgba(255,255,255,0.2)] after:opacity-0 hover:after:opacity-100 after:transition-opacity after:duration-300",
      },
      size: {
